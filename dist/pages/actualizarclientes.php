  ...
  <?php
include_once "./controladores/clientes/actualizarclientescontroladores.php";
?>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <h1>Actualizar Perfil De Cliente</h1>  
            <form method="get" action="index.php">
              ...
              <input type ="password" name="clave" class ="form-control" placeholder="Deje en blanco para no cambiarla" value = "<?php print $row['clave']?>">
              </div> 
              <div  class ="form-group">
              ...
              <div class="form group">
                <input type="hidden" name="modulo" value="actualizarclientes">
                <button type="submit" name="actualizar" VALUE="" class="btn btn-primary"> Actualizar</button>
