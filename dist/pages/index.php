    ...
    <div class="app-wrapper">
      ...
      <nav class="app-header navbar navbar-expand bg-body">
        ...
        <div class="container-fluid">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"><a href="index.php?modulo=inicio" class="nav-link active">Home</a></li>
            <li class="nav-item d-none d-md-block"><a href="index.php?modulo=perfil" class="nav-link active">Perfil</a></li>
          </ul>
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          <!--begin::Brand Link-->
          <a href="index.php?modulo=inicio" class="brand-link">
            <!--begin::Brand Image-->
            <img
            ...
            <?php if (isset($_SESSION["rol"]) && $_SESSION["rol"] === "usuario"): ?>
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="index.php?modulo=usuarios" class="nav-link">
...
if ($modulo == "borrarclientes"){
    include "borrarclientes.php";
}
if ($modulo == "actualizarclientes"){
    include "actualizarclientes.php";
}
if ($modulo == "usuarios"){
...
if ($modulo == "borrarusuarios"){
  include "borrarusuarios.php";
}
if ($modulo == "actualizarusuarios"){
