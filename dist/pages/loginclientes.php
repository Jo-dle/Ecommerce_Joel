...
fontsource/source-sans-3@5.0.12/index.css"
    ...
    <link
      rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/ove" html> <html lang='en'>
  <!--begin::Head-->
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Ecommerce | Login clientes</title>
    ...
    <link
      rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/@erlayscrollbars@2.10.1/styles/overlayscrollbars.min.css"
    ...
    <div class="login-box">
      ...
      <div class="card">
        <div class="card-body login-card-body">
          ...
          <form action="loginclientes.php" method="get">
            ...
            <div class="row">
              ...
              <!-- /.col -->
               <div class="d-grid gap-2 col-8 mx-auto">
                ...
                <a href="./tienda/index.php"class="btn btn-warning">Continuar sin cuenta</a>
                <a href="loginusuarios.php" class="btn btn-outline-success">Empleados</a>
               </div> 
               <!--
              <div class="d-md-flex justify-content-md-end">
               <a href="loginusuarios.php" class="btn btn-success">Empleados</a>
              -->
            </div>
